...
protected:
  ...
  void OnTerminal() override {
    ...
    wgpuTextureViewRelease(m_msaa_texture_view);
  }
  ...
  void InitMSAAResolve() {
    ...
    m_msaa_texture_view = wgpuTextureCreateView(texture, nullptr);
...
private:
  ...
  WGPUTextureView m_msaa_texture_view = {};
